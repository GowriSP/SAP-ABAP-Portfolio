REPORT z_purchase_order_material_alv.

*---------------------------------------------------------------------*
* Program : Z_PURCHASE_ORDER_MATERIAL_ALV
* Purpose : Purchase Order with Material Description
*---------------------------------------------------------------------*
...
*---------------------------------------------------------------------*
* Fetch Purchase Order and Material Data
*---------------------------------------------------------------------*
...
*---------------------------------------------------------------------*
      ...
      go_alv->get_display_settings( )->set_list_header(
        'Purchase Order Material Report' ).
